...
dat= read.csv("ThermalDatabase_all_10Nov2016.csv", na.strings="")
...
dat.lang= read.csv("ThermalDatabase_Fall2016_Languages_18Nov2016.csv", na.strings="")
dat.lang$Location_new= as.character(dat.lang$Location_new)
dat.lang$comments= as.character(dat.lang$comments)
...
match1= match(dat.lang$Order, dat$DatabaseOrder)
dat[match1, c("Location_new","lon_new","lat_new","quality","comments","omit", "colony","person")]= dat.lang[, c("Location_new","lon_new","lat_new","quality","comments","omit", "colony","person")]
